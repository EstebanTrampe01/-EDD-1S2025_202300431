            ...
            buttonBuscarUsuario.Clicked += delegate {
                ...
                if (int.TryParse(entryIdEditar.Text, out id))
                {
                    ...
                    if (usuario != null)
                    {
                        ...
                        labelContraseniaActual.Text = $"Contraseña: {GetFixedString(usuario->contrasena)}";
                ...
                if (int.TryParse(entryIdEliminar.Text, out id))
                {
                    ...
                    if (usuario != null)
                    {
                        using (var dialog = new MessageDialog(mainWindow,
                            ...
                            ButtonsType.YesNo,
                            $"¿Está seguro que desea eliminar al usuario {GetFixedString(usuario->name)} {GetFixedString(usuario->lastName)} (ID: {id})?"))
                        {
