...
namespace Matriz
{
    public unsafe class ListaEncabezado<T> where T : unmanaged
    {
        ...
        public void insertar_nodoEncabezado(int id)
        {
            ...
            // marshcal.allocHGlobal(sizeof(NodoEncabezado<int>)) asigna memoria no administrada
            // para un nodo de tipo NodoEncabezado<int> y devuelve un puntero a la dirección de memoria asignada
